...
👋 안녕하세요 저는 현재 미래에셋증권에 근무하면서 Spring Boot / FastAPI / Express 등을 통한 API 시스템 개발을 진행하고 있습니다.

이전에는 회사/개인 프로젝트 등을 통하여 ReactJS 등을 통한 Front-End 개발, Kotlin 기반의 Android 앱 개발 등의 업무를 진행해왔습니다.
...
| **근무지** | **기간** | **프로젝트** |
|:-----:|:---:|:---:|
| **미래에셋증권** | 2021. 06 ~ | 미래에셋증권 MTS 'M-STOCK' **통합검색/뉴스피드 API 시스템** 개발 <br/> Google  <=> 내부 Hadoop 서버 간 **데이터 송수신 파이프라인 개발** <br/> 미래에셋증권 홈페이지&모바일웹 Back-End 개발 및 운영 |
